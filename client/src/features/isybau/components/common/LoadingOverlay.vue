...
// Dieselbe Animation wie flood-2D/components/common/LoadingOverlay.vue
// (geteilte /public-Assets, hier bewusst als eigene Komponente statt
// Cross-Feature-Import — isybau hält die Feature-Grenze zu flood-2D
// konsequent ein, siehe z.B. KostraService.js/detectCRS in dieser Session).
