      ...
      <div class="modal-body">
        <div class="config-section">
          ...
          <div v-if="rainType === 'euler2'" class="form-group">
             ...
             <PixelSelect v-model="selectedReturnPeriod" :options="WIEDERKEHR_OPTIONEN" />
          </div>
        </div>
...
const apply = () => {
  ...
  store.setRainModel(rainModel);
  emit('apply', rainModel); // Keep emit for legacy but store is primary
  close();
};
</script>
