 ...
 *
 * GETEILT (Sprint I, Stufe 7): Diese Datei lag im PDF-Editor. Sie hat null
 * Abhaengigkeiten zu ihm — kein Store, kein pdfjs, kein pdf-lib — und ist
 * damit reine Geometrie. Der Rotstift der CDE braucht dieselbe: Umriss eines
 * Strichs, Treffer eines Radierers, Zerteilen an der Radierstelle.
 *
 * Sie zu kopieren waere die DRITTE Kopie eines CDE-Musters im PDF-Editor
 * gewesen (nach PdfRepo.js und CanvasAnnotDoc.js) — nur diesmal andersherum.
 * Deshalb liegt sie hier, und beide Features holen sie von hier.
 */
